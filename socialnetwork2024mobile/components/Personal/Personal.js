    ...
    <View style={PersonalStyles.container}>
      ...
      <ScrollView contentContainerStyle={PersonalStyles.content}>
        ...
        <View style={PersonalStyles.info}>
          <Image style={PersonalStyles.avatarCover} source={{uri: 'https://gamek.mediacdn.vn/133514250583805952/2020/7/11/narutossagemode-15944657133061535033027.png'}} />
          <Image style={PersonalStyles.avatar} source={{uri: 'https://gamek.mediacdn.vn/133514250583805952/2020/7/11/narutossagemode-15944657133061535033027.png'}} />
          <Text style={PersonalStyles.author}>Cựu SV A</Text>
        </View>
